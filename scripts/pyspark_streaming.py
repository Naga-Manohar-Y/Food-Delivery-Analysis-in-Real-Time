...
checkpointLocation = "s3://stream-checkpointing-nm/kinesistoRedshift/"
redshiftJdbcUrl = f"jdbc:redshift://redshift-cluster-1.ct5xrwqutdot.us-east-1.redshift.amazonaws.com:5439/dev"
redshiftTable = "food_delivery_datamart.factOrders"
tempDir = "s3://datawarehouse-temp-data-nm/temp-data/streaming_temp/"
