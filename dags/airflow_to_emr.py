...
jdbc_jar_s3_path = "s3://food-delivery-data-analysis-nm/redshift_connector_jar/redshift-jdbc42-2.1.0.12.jar"
    ...
    steps=[{
        ...
        'HadoopJarStep': {
            ...
            'Args': [
                ...
                's3://food-delivery-data-analysis/pyspark_scripts/pyspark_streaming.py',
